...
var RegisterService = (function () {
    ...
    RegisterService.prototype.createAuthorizationHeader = function (headers) {
    ...
    RegisterService.prototype.registerUser = function (body) {
        ...
        return this._http.post('/api/Connector/Save', content, { headers: headers }).map(function (res) { return res.json(); }).catch(this.handleError);
    };
